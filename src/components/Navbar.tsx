    ...
    <div className="p-2 lg:bg-transparent bg-slate-900/80">
      <h1
        className={classNames(
          "mt-4 text-2xl lg:text-4xl lg:text-start text-center lg:w-full w-fit mx-auto drop-shadow-xl backdrop-blur-sm cursor-pointer select-none p-2 px-8 lg:px-2 rounded-lg border border-indigo-200/80 xl:whitespace-nowrap",
      ...
      {/* Sidebar (< lg viewport) */}
      <ul className="lg:hidden flex justify-center mt-2 py-2 lg:py-4 w-full text-sm *:max-w-sm *:rounded-lg sm:*:mr-8 *:mr-3 *:px-1 *:text-center *:cursor-pointer *:border-indigo-200/50">
